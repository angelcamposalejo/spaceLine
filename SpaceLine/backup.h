...
protected:
	...
	void GetDialogTemplate(DLGTEMPLATE& dlgTemplate)
	{
		...
		dlgTemplate.cy = Sys::Convert::PixelToDlgUnitY(453);
	...
	void InitializeGui()
	{
		...
		tbxSalida.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE | ES_AUTOHSCROLL | ES_MULTILINE | ES_LEFT | ES_WINNORMALCASE, 13, 45, 352, 401, hWnd, 1000);
